...
@registry.BACKBONES.register('Resnet50_32x4d')
...
@registry.BACKBONES.register('Resnet101_32x8d')
def Resnet101_32x8d(cfg, pretrained=True):
    model = ResNet(Bottleneck, blocks = cfg.MODEL.RESNET.BLOCKS, extras = cfg.MODEL.RESNET.EXTRAS,
...
@registry.BACKBONES.register('wide_resnet50_2')
def wide_resnet50_2(cfg, pretrained=True):
    model = ResNet(Bottleneck, blocks = cfg.MODEL.RESNET.BLOCKS, extras = cfg.MODEL.RESNET.EXTRAS,
...
@registry.BACKBONES.register('wide_resnet101_2')
def wide_resnet101_2(cfg, pretrained=True):
    model = ResNet(Bottleneck, blocks = cfg.MODEL.RESNET.BLOCKS, extras = cfg.MODEL.RESNET.EXTRAS,
                   width_per_group = 64 * 2, se = cfg.MODEL.RESNET.SE, cbam = cfg.MODEL.RESNET.CBAM, fusion = cfg.MODEL.RESNET.FUSION)
    if pretrained:
